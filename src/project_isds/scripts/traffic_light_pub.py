...
class IMGParser:
    def __init__(self, pkg_name = 'ssafy_3'):
        self.model = torch.hub.load('/home/ssafy/catkin_ws/src/ssafy_3/scripts/yolov5/', 'custom', path='/home/ssafy/catkin_ws/src/ssafy_3/scripts/yolov5/best.pt', source='local', force_reload=True)
