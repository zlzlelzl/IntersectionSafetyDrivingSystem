...
# gps_parser 는 GPS의 위도/경도 데이터를 UTM 좌표로 변환하는 예제입니다.
# Pyproj 라이브러리를 사용 
...
class LL2UTMConverter:
    ...
    def navsat_callback(self, gps_msg):
        ...
        self.lat = gps_msg.latitude     # 위도
        self.lon = gps_msg.longitude    # 경도
        ...
        # os.system('clear')
        print(' longitude : ', self.lon)    # x = 경도
        print(' latitude : ', self.lat)     # y = 위도
        print(' utm X : ', self.x)
        print(' utm Y : ', self.y)
    ...
    def convertLL2UTM(self):
        ...
        # pyproj 라이브러리를 이용해 정의한 좌표 변환 변수를 이용하여 위도/경도 데이터를 변환한다.
