...
def talker():
    ...
    ego_setting_msg.ego_index = [ 0, 1]
    ego_setting_msg.global_position_x = [ 100, 110]
    ego_setting_msg.global_position_y = [ 100, 110]
    ...
    ego_setting_msg.gear=[ 1, 1]
    ego_setting_msg.ctrl_mode=[1, 1 ] 
