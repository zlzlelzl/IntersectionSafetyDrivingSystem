...
class dijkstra_path_pub :
    def __init__(self):
        ...
        self.start_node_pub = rospy.Publisher('/start_node',String, queue_size = 1)
        self.end_node_pub = rospy.Publisher('/end_node',String, queue_size = 1)
        ...
        while not rospy.is_shutdown():
            ...
            self.start_node_pub.publish(self.start_node)
            self.end_node_pub.publish(self.end_node)
            rate.sleep()
