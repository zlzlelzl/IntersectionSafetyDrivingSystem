...
class dijkstra_path_pub :
    def __init__(self):
        ...
        # self.vias = ["A119BS010168"] A119BS010701
        self.start_node = 'A119BS010184'
        self.end_node = 'A119BS010184'
        self.vias = ["A119BS010168","A119BS010754","A119BS010201"]
        # self.start_node = 'A119BS010184'
        # self.end_node = 'A119BS010184'
        # self.vias = ["A119BS010754"]
        

        # self.start_node = 'A119BS010184'
        # self.end_node1 = 'A119BS010168'
        # self.end_node2 = 'A119BS010156'
        # self.start_node = 'A119BS010176'
        # self.end_node1 = 'A119BS010190'
        # self.end_node2 = 'A119BS010330'
    ...
    # def calc_dijkstra_path_node(self, start_node, end_node1, end_node2):

    #     result, path1 = self.global_planner.find_shortest_path(start_node, end_node1)
    #     result, path2 = self.global_planner.find_shortest_path(end_node1, end_node2)
    ...
    #     '''
    #     for i in path1['point_path']:
    #         tmp = PoseStamped()
    #         tmp.pose.position.x = i[0]
    #         tmp.pose.position.y = i[1]
    #         tmp.pose.position.z = i[2]
    #         out_path.poses.append(tmp)

    #     for num,i in enumerate(path2['point_path']):
    #         if num == 0:
    #             continue
