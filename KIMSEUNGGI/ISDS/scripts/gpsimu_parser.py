    ...
    def __init__(self):
        ...
        while not rospy.is_shutdown():
            if self.is_imu==True and self.is_gps == True:
                ...
                odom_quaternion=(self.odom_msg.pose.pose.orientation.x,self.odom_msg.pose.pose.orientation.y,self.odom_msg.pose.pose.orientation.z,self.odom_msg.pose.pose.orientation.w)
                ...
                print("yaw:{0}".format(self.vehicle_yaw))
