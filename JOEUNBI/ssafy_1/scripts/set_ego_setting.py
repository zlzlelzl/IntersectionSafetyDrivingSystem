...
def talker():
    ...
    ego_setting_msg.number_of_ego_vehicle = 2
    ego_setting_msg.camera_index = 1
    ego_setting_msg.ego_index = [1, 2]
    ego_setting_msg.global_position_x = [10, 100]
    ego_setting_msg.global_position_y = [10, 100]
    ego_setting_msg.global_position_z = [10, 10]
    ego_setting_msg.global_roll = [0, 0]
    ego_setting_msg.global_pitch = [0, 0]
    ego_setting_msg.global_yaw = [0, 0]
    ego_setting_msg.velocity=[70, 30]
    ego_setting_msg.gear=[4, 3]
    ego_setting_msg.ctrl_mode=[1, 16] 
